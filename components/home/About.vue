<template>
  <div class="relative bg-gray-50 border-b">
    <div class="h-56 bg-green-800 sm:h-72 md:absolute md:left-0 md:h-full md:w-1/2"><img class="w-full h-full object-cover" src="https://laravel.cm/images/preview.png?8ab78133fc9a91f5cb369209235d41f0" alt="Developer"></div>
    <div class="relative px-10 py-16">
                    <div class="md:ml-auto md:w-1/2 md:pl-10">
                      ...
                      <p class="mt-6 leading-7 text-gray-600">
                        Experienced Fullstack developer with great emphasis on Software Engineering, and a strong background in PHP, Javascript, Python and web development tools. 
                        <br class="block mt-2.5">
                        I offer my expertise to address my customers requirements and build robust and high quality software in a fast and efficient way.
                        <br class="block mt-2.5">
                      ...
                      <div class="mt-8">
                        <h5 class="text font-semibold text-gray-900 mb-4">For business inquiries feel free to get in touch with me at:</h5>
                        <ul class="mb-4 flex flex-col sm:text-left space-y-2">
                          <li>
                            <span class="bg-green-100 text-green-600 w-4 h-4 mr-2 rounded-full inline-flex items-center justify-center">
                              <svg
                                fill="none"
                                stroke="currentColor"
                        ...
                        <h5 class="text font-semibold text-gray-900 mb-6">Or somewhere else on the web:</h5>
