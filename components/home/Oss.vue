    ...
    <section class="text-gray-600 border-b bg-white">
      <div class="container max-w-screen-lg mx-auto py-16">
        ...
        <div class="grid grid-cols-2 gap-6">
            ...
            >
              <div>
                <h5 class="text-lg leading-6 font-medium text-gray-900">{{ project.name }}</h5>
                <p class="mt-4 mb-6 text-base leading-6 text-gray-500">{{ project.description }}</p>
            ...
            <div class="flex items-center justify-center">
              <a
                ...
                target="_blank"
              >
                <svg class="text-white h-6 w-6 mr-3" fill="currentColor">
...
export default {
  ...
  methods: {
    async getGithubRepositories() {
      ...
      let response = await this.$axios.$get('https://api.github.com/search/repositories?q=user:mouadziani%20feautred%20repository%20in:readme&sort=stars&order=desc&per_page=5')
